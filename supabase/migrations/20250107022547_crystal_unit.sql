/*
  ...
  1. Tables
    - Recreates dashboard_metrics
    - Recreates historical_metrics
    - Recreates buddy_pairs
  
  2. Data
    - Restores metrics for all officers
    - Restores historical data
    - Restores buddy pairs
*/

-- First ensure we have all users
DO $$
DECLARE
  amitabh_id uuid;
  dharmendra_id uuid;
